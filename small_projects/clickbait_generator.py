# This program generates as many headlines as you need from a Mad Libs–style template.
...
def main():
    print('Clickbait Headline Generaton')
    print()
    print('Our website needs to trick people into looking at ads!!!')
    
    while True:
        print('Enter the number od clickbait headlines to generate: ')
        response = input('>>')
    ...
    website = random.choice(['website' , 'blog' , 'Facebook' , 'Google' , 'Instagram' , 'Twitter'])
